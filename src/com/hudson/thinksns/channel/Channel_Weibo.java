...
import com.hudson.thinksns.develop.SearchWeiBo;
...
*/  
@SuppressLint("NewApi")
public class Channel_Weibo extends Fragment implements IXListViewListener
{
		...
		mHandler = new Handler() {
			...
			public void handleMessage(Message msg) {
				...
				case 0x22:
					...
					mWeiboListAdapter = new WeiboListAdapter(m_position, "get_channel_feed",
							Channel_Weibo.this, mListView, mstatuses,
